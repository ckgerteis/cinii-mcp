...
```bash
pip install "git+https://github.com/ckgerteis/cinii-mcp@v3.1.1"
# or, without an environment of your own:
uvx --from "git+https://github.com/ckgerteis/cinii-mcp@v3.1.1" cinii-mcp
```
